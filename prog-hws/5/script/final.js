...
{ 
	...
	var init = function()
	{
		...
		{
			console.clear();
			console.log("xm: ", xm, " ym: ", ym, " nx: ", nx, " ny: ", ny, " nw: ", nw, " nh: ", nh);
			console.log("cx: ", cx, " cy: ", cy, " cz: ", cz, " cxb: ", cxb, " cyb: ", cyb);
			console.log("autorotate: ", autorotate, " running: ", running, " drag: ", drag, " moved: ", moved);
			console.log("startX: ", startX, " startY: ", startY);
			console.log("cosY: ", cosY, " cosX: ", cosX, " cosZ: ", cosZ);
			console.log("sinY: ", sinY, " sinX: ", sinX, " sinZ: ", sinZ);
			console.log("minZ: ", minZ);
			console.log("angleY: ", angleY, " angleX: ", angleX, " angleZ: ", angleZ);
